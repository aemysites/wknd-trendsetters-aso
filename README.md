...
## Environments
- Preview: https://main--wknd-trendsetters-aso--aemysites.aem.page/
- Live: https://main--wknd-trendsetters-aso--aemysites.aem.live/
- Block Library: https://main--wknd-trendsetters-aso--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `wknd-trendsetters-aso` directory in your favorite IDE and start coding :)
